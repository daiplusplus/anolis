namespace Anolis.Resourcer {
	partial class OptionsForm {
		...
		private void InitializeComponent() {
			...
			this.@__sGimmickLbl = new System.Windows.Forms.Label();
			this.@__sGimmick = new System.Windows.Forms.CheckBox();
			...
			this.@__sUiGrp.Size = new System.Drawing.Size(340, 163);
			...
			this.@__sAssoc.Location = new System.Drawing.Point(6, 101);
			...
			// __sGimmickLbl
			// 
			this.@__sGimmickLbl.Location = new System.Drawing.Point(15, 79);
			this.@__sGimmickLbl.Name = "__sGimmickLbl";
			this.@__sGimmickLbl.Size = new System.Drawing.Size(319, 19);
			this.@__sGimmickLbl.TabIndex = 5;
			this.@__sGimmickLbl.Text = "Enables window fade and drop-shadow effects (requires restart)";
			// 
			// __sGimmick
			// 
			this.@__sGimmick.AutoSize = true;
			this.@__sGimmick.Location = new System.Drawing.Point(6, 60);
			this.@__sGimmick.Name = "__sGimmick";
			this.@__sGimmick.Size = new System.Drawing.Size(121, 17);
			this.@__sGimmick.TabIndex = 4;
			this.@__sGimmick.Text = "Enable UI Gimmicks";
			this.@__sGimmick.UseVisualStyleBackColor = true;
			// 
			// __sAssocWarnLbl
			// 
			this.@__sAssocWarnLbl.AutoSize = true;
			this.@__sAssocWarnLbl.Location = new System.Drawing.Point(15, 143);
			...
			this.@__sAssocLbl.Location = new System.Drawing.Point(15, 123);
			...
			this.@__sUIButtonsLargeLbl.Location = new System.Drawing.Point(15, 39);
			...
			this.@__sUIButtonsLarge.Location = new System.Drawing.Point(6, 19);
			...
			this.@__sMoreGrp.Location = new System.Drawing.Point(6, 175);
			this.@__sMoreGrp.Name = "__sMoreGrp";
			this.@__sMoreGrp.Size = new System.Drawing.Size(340, 163);
			...
			this.@__sLib.Size = new System.Drawing.Size(325, 75);
			...
			this.@__tAbout.Controls.Add(this.@__aboutVersionLbl);
			this.@__tAbout.Controls.Add(this.@__aboutVersion);
			this.@__tAbout.Controls.Add(this.@__aboutLinksLbl);
			this.@__tAbout.Controls.Add(this.@__aboutLinkAnolis);
			this.@__tAbout.Controls.Add(this.@__aboutLinkCodeplex);
			...
			// __aboutVersionLbl
			// 
			this.@__aboutVersionLbl.AutoSize = true;
			this.@__aboutVersionLbl.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.@__aboutVersionLbl.Location = new System.Drawing.Point(9, 138);
			this.@__aboutVersionLbl.Name = "__aboutVersionLbl";
			this.@__aboutVersionLbl.Size = new System.Drawing.Size(49, 13);
			...
			// __aboutLinksLbl
			// 
			this.@__aboutLinksLbl.AutoSize = true;
			this.@__aboutLinksLbl.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.@__aboutLinksLbl.Location = new System.Drawing.Point(9, 186);
			this.@__aboutLinksLbl.Name = "__aboutLinksLbl";
			this.@__aboutLinksLbl.Size = new System.Drawing.Size(36, 13);
			...
			this.@__aboutLinkCodeplex.Size = new System.Drawing.Size(184, 14);
			this.@__aboutLinkCodeplex.TabIndex = 3;
