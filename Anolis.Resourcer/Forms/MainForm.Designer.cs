namespace Anolis.Resourcer {
	partial class MainForm {
		...
		private void InitializeComponent() {
			...
			this.@__tSrcNew = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.@__tSrcMruSep2 = new System.Windows.Forms.ToolStripSeparator();
			this.@__tSrcBatch = new System.Windows.Forms.ToolStripMenuItem();
			...
			// __tSrcMruSep1
			// 
			@__tSrcMruSep1.Name = "__tSrcMruSep1";
			@__tSrcMruSep1.Size = new System.Drawing.Size(150, 6);
			// 
			// __tSrcSaveSep
			// 
			...
			// __tSrcNew
			// 
			this.@__tSrcNew.Name = "__tSrcNew";
			this.@__tSrcNew.Size = new System.Drawing.Size(153, 22);
			this.@__tSrcNew.Text = "Create New...";
			// 
			// __tSrcMruInfo
			// 
			this.@__tSrcMruInfo.Enabled = false;
			this.@__tSrcMruInfo.Name = "__tSrcMruInfo";
			this.@__tSrcMruInfo.Size = new System.Drawing.Size(153, 22);
			this.@__tSrcMruInfo.Text = "Recent Files List";
			// 
			// __tSrcMruClear
			// 
			this.@__tSrcMruClear.Name = "__tSrcMruClear";
			this.@__tSrcMruClear.Size = new System.Drawing.Size(153, 22);
			this.@__tSrcMruClear.Text = "Clear List";
			// 
			// __tSrcMruSep2
			// 
			this.@__tSrcMruSep2.Name = "__tSrcMruSep2";
			this.@__tSrcMruSep2.Size = new System.Drawing.Size(150, 6);
			// 
			// __tSrcBatch
			// 
			this.@__tSrcBatch.Name = "__tSrcBatch";
			this.@__tSrcBatch.Size = new System.Drawing.Size(153, 22);
			this.@__tSrcBatch.Text = "Batch Process...";
			// 
			// __tSrcSave
			// 
