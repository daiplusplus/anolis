namespace Anolis.Resourcer {
	partial class MainForm {
		...
		private void InitializeComponent() {
			...
			@__tSrcMruSep1.Size = new System.Drawing.Size(159, 6);
			// 
			// __tSrcSaveSep
			// 
			...
			this.@__tSrcMruSep2.Size = new System.Drawing.Size(159, 6);
			// 
			// __tSrcNew
			// 
			this.@__tSrcNew.Name = "__tSrcNew";
			this.@__tSrcNew.Size = new System.Drawing.Size(162, 22);
			this.@__tSrcNew.Text = "Create New...";
			// 
			// __tSrcBatch
			// 
			this.@__tSrcBatch.Name = "__tSrcBatch";
			this.@__tSrcBatch.Size = new System.Drawing.Size(162, 22);
			this.@__tSrcBatch.Text = "Batch Export...";
			// 
			// __tSrcSave
			// 
