...
//		}
	...
	internal struct VSFixedFileInfo {
		[FieldOffset(0x00)] public UInt32                   Signature;
		[FieldOffset(0x04)] public UInt32                   StrucVersion;
		[FieldOffset(0x08)] public UInt32                   FileVersionMS;
		[FieldOffset(0x0C)] public UInt32                   FileVersionLS;
		[FieldOffset(0x10)] public UInt32                   ProductVersionMS; 
		[FieldOffset(0x14)] public UInt32                   ProductVersionLS; 
		[FieldOffset(0x18)] public UInt32                   FileFlagsMask; 
		[FieldOffset(0x1C)] public VSFixedFileFlags         FileFlags; 
		[FieldOffset(0x20)] public VSFixedFileOS            FileOS; 
		[FieldOffset(0x24)] public VSFixedFileType          FileType;
		[FieldOffset(0x28)] public UInt32                   FileSubType;
		[FieldOffset(0x28)] public VSFixedFileSubTypeDriver FileSubTypeDriver;
		[FieldOffset(0x28)] public VSFixedFileSubTypeFont   FileSubTypeFont;
		[FieldOffset(0x2C)] public UInt32                   FileDateMS; 
		[FieldOffset(0x30)] public UInt32                   FileDateLS;
